...
class Event(models.Model):
    ...
    event_name = models.IntegerField( choices=EVENT_CHOICES, null=True, blank=True)
    event_category = models.IntegerField(choices=EVENT_CATEGORY_CHOICES, null=True, blank=True)
    ...
    event_coordinates = models.ForeignKey(Event_Coordinates, on_delete=models.CASCADE, related_name="coordinates",
